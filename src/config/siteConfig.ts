...
export const siteConfig: SiteConfig = {
	title: "Interfere Verge",
	subtitle: "共振边际乐队官方网站",
	siteURL: "https://interfere-verge.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	navbarTitle: {
		...
		mode: "text-icon",
		// 顶栏标题文本
		text: "Interfere Verge",
		// 顶栏标题图标路径
		icon: "assets/home/interfere-verge-logo.jpg",
		// 网站Logo图片路径
		logo: "assets/home/interfere-verge-logo.jpg",
	},
	...
	banner: {
		...
		// 桌面端与移动端使用同一组乐队背景图，由 scripts/prepare-band-assets.mjs 生成
		src: {
			desktop: [
		...
		homeText: {
			...
			// 不显示副标题。留空即可，Banner 组件在 subtitle 缺失时不会渲染这一行。
			typewriter: {
	...
	favicon: [
		// 乐队 logo 作为站点图标
		{
			src: "/assets/home/interfere-verge-logo.jpg",
		},
	],
